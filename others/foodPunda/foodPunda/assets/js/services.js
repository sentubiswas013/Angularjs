...
.factory('sharedFilterService', [function(){
	...
	var obj = {};
    obj.str = "https://vishwaas.000webhostapp.com/vishwaas_app/foodPunda/food_punda_tab_food_menu.php";
	obj.sort = "";
	obj.search = "";
	obj.category = "";
	...
	obj.getUrl=function(){
		if(obj.sort!="" && obj.category!=""){
			//obj.str="https://vishwaas.000webhostapp.com/vishwaas_app/foodPunda/food_punda_tab_food_menu.php?category="+obj.category+"&sort="+obj.sort;
		}
		else if(obj.category!="" ){
			//obj.str="https://vishwaas.000webhostapp.com/vishwaas_app/foodPunda/food_punda_tab_food_menu.php?category="+obj.category;
		}
		else if(obj.sort!=""){
			//obj.str="https://vishwaas.000webhostapp.com/vishwaas_app/foodPunda/food_punda_tab_food_menu.php?sort="+obj.sort;
		}
		return obj.str;
	};
	return obj;
